      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
            ...
            <img class="img-fluid" src="{{asset('asset/public/img/portfolio/01-thumbnail.jpg')}}" alt="">
          </a>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
            ...
            <img class="img-fluid" src="{{asset('asset/public/img/portfolio/02-thumbnail.jpg')}}" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Explore</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
            ...
            <img class="img-fluid" src="{{asset('asset/public/img/portfolio/03-thumbnail.jpg')}}" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Finish</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
            ...
            <img class="img-fluid" src="{{asset('asset/public/img/portfolio/04-thumbnail.jpg')}}" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Lines</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
            ...
            <img class="img-fluid" src="{{asset('asset/public/img/portfolio/05-thumbnail.jpg')}}" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Southwest</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal6">
            ...
            <img class="img-fluid" src="{{asset('asset/public/img/portfolio/06-thumbnail.jpg')}}" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Window</h4>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6">
          <a href="#">
            <img class="img-fluid d-block mx-auto" src="{{asset('asset/public/img/logos/envato.jpg')}}" alt="">
          </a>
        </div>
        <div class="col-md-3 col-sm-6">
          <a href="#">
            <img class="img-fluid d-block mx-auto" src="{{asset('asset/public/img/logos/designmodo.jpg')}}" alt="">
          </a>
        </div>
        <div class="col-md-3 col-sm-6">
          <a href="#">
            <img class="img-fluid d-block mx-auto" src="{{asset('asset/public/img/logos/themeforest.jpg')}}" alt="">
          </a>
        </div>
        <div class="col-md-3 col-sm-6">
          <a href="#">
            <img class="img-fluid d-block mx-auto" src="{{asset('asset/public/img/logos/creative-market.jpg')}}" alt="">
          </a>
        </div>
      </div>
    </div>
