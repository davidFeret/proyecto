        ...
        <div class="col-md-12" style="padding:20px;">
            <div class="col-md-12 padding-0">
                <div class="col-md-12 padding-0">
                    ...
                    <div class="panel">
                        <a href="/login">Click aquí para ir a login</a> <br>
                        <a href="/admin/usuarios/nuevo">Click aquí para ir a agregar usuario</a> <br>
                        <a href="/admin/usuarios/registros">Click aquí para ir a registros de usuario</a> <br>
                        <a href="/admin/productos/nuevo">Click aquí para ir a agregar producto</a> <br>
                        <a href="/admin/productos/registros">Click aquí para ir a registros de productos</a> <br>
                    </div>
